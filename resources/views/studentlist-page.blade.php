                        ...
                        <td>
                            <div class="flex gap-2">
                                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                    onclick="openDeskList('{{ $student->id }}')">Assign Desk</button>
                                    
                                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                                    onclick="openDeleteConfirmation('{{ $student->id }}')">Delete</button>
                            </div>
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
            ...
            <form id="assignDeskForm" action="{{ route('assign-desk') }}" method="POST">
                ...
                <button type="button"
                    ...
                    onclick="closeDeskModal()">Cancel</button>
            </form>
        </div>
    </div>

    <!-- Modal For Add Student Desk -->
                ...
                <form action="{{ route('register-student') }}" method="POST" class="flex flex-col gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="id" type="text" name="id" placeholder="Enter ID" required>
                    </div>
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="email_address" type="text" name="email_address" placeholder="Enter Email Address"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="first_name" type="text" name="first_name" placeholder="Enter First Name"
                            required>
                    </div>
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="last_name" type="text" name="last_name" placeholder="Enter Last Name" required>
                    </div>
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="phone_no" type="text" name="phone_no" placeholder="Enter Phone Number" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="address">
                            Address
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="address" type="text" name="address" placeholder="Enter Address" required>
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white w-1/2 mx-auto p-6 rounded shadow">
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <form id="deleteForm">
                        <button id="deleteStudent" type="button"
