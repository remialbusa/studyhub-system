...
<body class="w-full h-screen" style="background-image: url('/public/images/preloader.png')">
    <!-- pre-loader -->
    ...
    <section class="bg-green-900 min-h-screen flex items-center justify-center">
        ...
        <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-screen-xl mx-auto px-[100px] p-5 pt-[50px] items-center">
            <!-- form -->
            <div class="">
                <h2 class="font-bold text-2xl text-[#002D74] flex justify-center items-center mb-10">ADMIN LOGIN</h2>

                <form action="{{route('login-user')}}" method="POST" class="flex flex-col gap-4 px-[100px]">
                    ...
                    <div class="relative">
                        <input name="username" input id="username" value="{{old('username')}}" class="p-2 rounded-xl border w-full" type="text" placeholder="Username" />
