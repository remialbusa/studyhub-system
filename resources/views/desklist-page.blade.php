...
<body>
   ...
   <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 sm:ml-64">
      ...
      {{-- add desk button --}}
      <button type="button" data-modal-target="deskListModal" data-modal-show="deskListModal" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-80">New Desk</button>
         ...
         <div id="deskListModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-2xl max-h-full">
               ...
               {{-- <ebion="" method="POST" class="relative bg-white rounded-lg shadow dark:bg-gray-700"> --}}
                  <form action="{{route('desklist-page-add')}}" method="POST" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  @csrf
                  ...
                  <div class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                           <div class="col-span-6 sm:col-span-3">
                              ...
                              <input type="text" name="Desk Code" id="desk_code" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="" required="">
                           </div>
                           <div class="col-span-6 sm:col-span-3">
