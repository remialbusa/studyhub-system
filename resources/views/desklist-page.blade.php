    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 sm:ml-64">
            ...
            <tbody>
                @foreach ($list as $data)
                    <tr>
                        ...
                        {{-- for update button --}}
                        <td> <button type="button" onclick="editDesk({{ json_encode($data) }})"
                            ...
                            <button data-modal-target="popup-modal" onclick="deleteDesk({{ json_encode($data) }})"
        ...
        <div id="deskListModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <form action="{{ route('desklist-page-add') }}" method="POST"
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="Desk ID" id="add_id"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="Desk Code"
                                    ...
                                    Code</label>
                                <input type="text" name="Desk Code" id="add_desk_code"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="Description" id="add_desc"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                    ...
                    <div
                        ...
                        {{-- <button type="button" button id="btn-add" onclick="addDesk()" --}}
                        <button type="button" button id="btn-add" onclick="addDesk()"
        ...
        <div id="editUserModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" id="userform">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="Desk Code"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Desk
                                    Code</label>
                                <input type="text" name="Desk Code" id="desk_code"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                    ...
                    <div
                        class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button id="btn-update" type="button" onclick="updateDesk()"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Save all</button>
                    </div>
                </form>
        ...
        <script>
            function addDesk() {
                ...
                var desk_code = document.getElementById('add_desk_code').value
                ...
                formData.append('add_desk_code', desk_code);
                formData.append('add_desc', desc);
                formData.append('add_status', status);
                xhr.send(formData);
        }

            function editDesk(data) {
                document.getElementById('id').value = data.id;
                document.getElementById('desk_code').value = data.desk_code;
            ...
            function updateDesk() {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open("POST", '/update-desk/' + id, true);
                xhr.setRequestHeader('X-CSRF-TOKEN', '{{ csrf_token() }}');
                ...
                formData.append('desk_code', desk_code);
            ...
            function deleteDesk(data) {
                console.log(data);

                document.getElementById('deletelabel').textContent = "Are you sure you want to delete " + data.desk_code +
                    "?";
                ...
                button.addEventListener('click', function() {
                    ...
                    var xhr = new XMLHttpRequest();
                    xhr.open("GET", "/delete-desk/" + data.id, true);
                    xhr.onreadystatechange = function() {
                        if (xhr.readyState === XMLHttpRequest.DONE) {
                            if (xhr.status === 200) {
